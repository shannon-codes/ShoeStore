...
<body>
	...
	<div
		...
		<a class="py-2 d-none d-md-inline-block" href="LoginFirst.jsp">LOG
			IN</a> <a class="py-2 d-none d-md-inline-block"
			href="UserEditOrderForm.jsp">EDIT ORDER PLACED</a> <a
			class="py-2 d-none d-md-inline-block" href="Cart.jsp">CART</a> </a>
	</div>
	</nav>
	...
	<div
		...
		<div class="col-md-5 p-lg-5 mx-auto my-5">
			<h1 class="display-4 font-weight-normal">Men's Shoes</h1>
		</div>
		...
		<div
			...
			<div class="my-3 py-3">
				<form target="_self" method="get" action="CartAdding">
					...
					</select> <input type="hidden" value="10" name="price"> <input
						type="hidden" value="1" name="itemId"> <input
						class="btn btn-outline-secondary" type="submit" value="CART"
						name="cart">
				</form>
			</div>
			...
			<div class="my-3 p-3">
				<form target="_self" method="get" action="CartAdding">
					<select name="size1" class="btn btn-outline-secondary">
						...
						type="hidden" value="2" name="itemId"> <input
						class="btn btn-outline-secondary" type="submit" value="CART"
						name="cart">
				</form>
			</div>
			...
			<div class="my-3 p-3">
				<form target="_self" method="get" action="CartAdding">
					<select name="size1" class="btn btn-outline-secondary">
						...
						type="hidden" value="3" name="itemId"> <input
						class="btn btn-outline-secondary" type="submit" value="CART"
						name="cart">
				</form>
			</div>
		...
		<div
			...
			<div class="my-3 py-3">
				<select name="size1" class="btn btn-outline-secondary">
					...
					type="hidden" value="4" name="itemId"> <input
					class="btn btn-outline-secondary" type="submit" value="CART"
					name="cart">
			</div>
			<div class="bg-light shadow-sm mx-auto"
			...
			<div class="my-3 py-3">
				<form target="_self" method="get" action="CartAdding">
					<select name="size1" class="btn btn-outline-secondary">
						...
						type="hidden" value="5" name="itemId"> <input
						class="btn btn-outline-secondary" type="submit" value="CART"
						name="cart">
				</form>
			</div>
			...
			<div class="my-3 p-3">
				<form target="_self" method="get" action="CartAdding">
					<select name="size1" class="btn btn-outline-secondary">
						...
						type="hidden" value="6" name="itemId"> <input
						class="btn btn-outline-secondary" type="submit" value="CART"
						name="cart">
				</form>
			</div>
