...
<body>
	...
	<nav class="site-header sticky-top py-1s">
	<div
	...
	<div
		...
		<div class="col-md-5 p-lg-5 mx-auto my-5">
			<h1 class="display-4 font-weight-normal">LOG IN</h1>
			<br> <br> <a class="btn btn-outline-secondary"
				href="LoginSecond.jsp">LOG IN</a>
		</div>

		<hr>
		<div class="col-md-5 p-lg-5 mx-auto my-5">
			<h1 class="display-4 font-weight-normal">NEW CUSTOMER</h1>
			<br> <br> <a class="btn btn-outline-secondary"
				href="CreateAccount.jsp">SIGN IN</a>
		</div>
