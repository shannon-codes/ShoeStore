		...
		<div class="col-md-5 p-lg-5 mx-auto my-5">
			...
			<form method="get" action="UserRegister">
				...
				<br> <input type="text" name="city" placeholder="CITY"
					required="required"> <br>
				<br> <input type="text" name="code" placeholder="POSTAL CODE"
					required="required"> <br>
				<br> <input type="submit" class="btn btn-outline-secondary"
					value="ID CHECK" name="bu"> <input type="submit"
					class="btn btn-outline-secondary" value="REGISTER" name="bu">
				<br>
				<br>
				<p>
					If new account is created successfully,<br> you can
