...
<body>
	...
	<div
		...
		<a class="py-2 d-none d-md-inline-block" href="LoginFirst.jsp">LOG
			IN</a> <a class="py-2 d-none d-md-inline-block" href="CreateAccount.jsp">SIGN
			UP</a> <a class="py-2 d-none d-md-inline-block" href="UserViewOrder.jsp">CART</a>
	</div>
	</nav>
	...
	<div
		...
		<div class="col-md-5 p-lg-5 mx-auto my-5">
			...
			<p class="lead font-weight-normal">Take 30% off your order of $99
				or more</p>
